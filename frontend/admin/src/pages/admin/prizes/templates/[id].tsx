// frontend/admin/src/pages/admin/prizes/templates/[id].tsx

import { useEffect } from 'react';
import { useRouter } from 'next/router';
import { DashboardLayout } from '@/features/dashboard/components/DashboardLayout';
import { useTemplateStore } from '@/features/prizes/store/PrizeTemplateStore';
import { 
    Card, 
    CardHeader, 
    CardTitle, 
...
import { PRIZE_TIERS } from '@/types/prizes';
            ...
            <DashboardLayout>
                <div className="px-6 py-8">
                    <ErrorState
                        ...
                        message={error}
                        onRetry={() => id && getTemplate(parseInt(id.toString(), 10))}
                    />
                </div>
            </DashboardLayout>
        );
...
TemplateDetailPage.displayName = 'TemplateDetailPage';
